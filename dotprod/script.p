...
#dotprod gcc
set title 'mesures of gcc compiler with O0 flag in DOT PRODUCT operation'                       # plot title
...
set title 'mesures of gcc compiler with O1 flag in DOT PRODUCT operation'                       # plot title
...
set title 'mesures of gcc compiler with O2 flag in DOT PRODUCT operation'                       # plot title
...
set title 'mesures of gcc compiler with O3 flag in DOT PRODUCT operation'                       # plot title
...
#clang
set title 'mesures of clang compiler with O1 flag in DOT PRODUCT operation'                       # plot title
...
set title 'mesures of clang compiler with O2 flag in DOT PRODUCT operation'                       # plot title
...
set title 'mesures of clang compiler with O3 flag in DOT PRODUCT operation'                       # plot title
